...
4. **Interact (hands)** — she **uses** the thing: smell rice, ring a bell, pull a curtain aside, knock, lift a lantern, dip a ladle. Walking past is a fail. Last frame shows the result. Clips may **create** the kitchen, cook, food, bell, curtain by walking in — that's how the world grows. See `docs/object-interactions.md`.
